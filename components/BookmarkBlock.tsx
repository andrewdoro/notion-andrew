    ...
    <div className="mt-2 mb-4">
      {error ? (
        ...
        <a
          ...
          href={url}>
          <div className="w-full flex-1 bg-zinc-50 p-4 group-hover:bg-zinc-100  dark:bg-zinc-900 dark:group-hover:bg-zinc-800  ">
            {data === undefined ? (
            ...
            {data === undefined ? (
              ...
              <p className="mt-1 text-xs font-thin text-gray-600 line-clamp-2 dark:text-gray-300">
                {data?.description}
              </p>
            )}
            ...
            <div className="relative mt-2 flex items-center gap-2 ">
              ...
              <p className="flex-1 text-xs text-black line-clamp-1 dark:text-white">{url}</p>
            </div>
          </div>
          <div className="relative hidden h-full w-1/3 md:block">
            {data?.open_graph.images !== undefined ? (
              ...
              <div className="hidden h-32 w-full animate-pulse rounded-r-lg bg-zinc-900 bg-opacity-10 dark:bg-zinc-50  dark:bg-opacity-10 md:block"></div>
            )}
          </div>
        </a>
      )}
